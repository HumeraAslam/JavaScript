...
console.log(make_album("Big Thief", "Dragon New Warm Mountain I Believe in You" ))
console.log(make_album(" SAULT","Earth"))
console.log(make_album("Black Country", "New Road - Ants From Up There ", 5))
