...
let places = ['Saudia Arabia', 'Pakistan', 'Turkey', 'UK', 'China'];
...
console.log(`Reversed order: "${places.slice().reverse()}"`);
console.log(`Reversed back to original order: "${places.slice().reverse()}"`);
